...
# e_dna panama
dbExecute(connection, "alter table edna_panama_survey add primary key(panama_survey_id);")

dbExecute(connection, "update edna_panama_survey p
                       set visit_id =
                       	(select visit_id
                       	from edna_visit v
                       	where (p.site, p.date_collected) = (v.site, v.date_collected));")

dbExecute(connection, "alter table edna_panama_survey 
                       add constraint fk_panama_survey foreign key (visit_id) 
...
dbExecute(connection, "alter table edna_panama_survey drop column region;")

dbExecute(connection, "alter table edna_panama_survey drop column site;")

dbExecute(connection, "alter table edna_panama_survey drop column date_collected;")
